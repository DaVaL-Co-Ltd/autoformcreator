...
export const BLOG_CATEGORY_PROFILES = {
  ...
  resource_share: {
    ...
    suitableSources: ['자료 배포 안내', '다운로드/신청 안내', '마감 공지', '제공 자료 구성'],
    exampleLinks: [
      { title: '자료 나눔 예시', url: 'https://m.blog.naver.com/onlyjungdw/224267495059' },
      { title: '자료 공유 예시', url: 'https://m.blog.naver.com/onlyjungdw/224241244274?referrerCode=1' },
    ],
    ctaLevel: 'high',
    recommendedImageStyle: 'solid-pattern',
  ...
  service_promo: {
    ...
    suitableSources: ['서비스 소개서', '상담/프로그램 안내', '이용 방법', '마케팅 소식지'],
    exampleLinks: [
      { title: '마이베스트 워크북 소개 예시', url: 'https://m.blog.naver.com/onlyjungdw/223940821569?referrerCode=1' },
      { title: '마이베스트 컨설팅 활용법 예시', url: 'https://m.blog.naver.com/onlyjungdw/223941619756?referrerCode=1' },
    ],
    ctaLevel: 'medium',
    recommendedImageStyle: 'photo',
