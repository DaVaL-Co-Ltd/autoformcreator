    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
        {overviewStats.map((statItem) => {
          ...
          return (
            <div key={statItem.label} className="bg-surface rounded-xl border border-border p-4 hover:border-primary/20 transition-colors">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-text-muted">{statItem.label}</span>
                <div className={`p-1.5 rounded-lg ${statItem.bg}`}>
                  <StatIcon size={14} className={statItem.color} />
                </div>
              </div>
              <p className="text-2xl font-bold text-text">{statItem.value}</p>
            </div>
          )
        })}
      </div>
              ...
              <div className="p-4">
                <div className="flex items-center gap-3 mb-4">
                  <div className={`w-10 h-10 rounded-xl ${p.bg} flex items-center justify-center`}>
                    <PlatformIcon size={20} className={p.color} />
                  </div>
