...
scenes[].layout, scenes[].infographic 같은
...
- 퀴즈형 컨셉(ox_quiz)은 각 문제를 질문 씬('full') → 대기 씬('quiz-countdown', narration 은 빈 문자열) → 정답 씬('full') 3개로 구성하고, 한 문제의 3개 씬은 모두 같은 avatarId 를 지정하세요. 대기 씬 배경 카운트다운 영상은 시스템이 자동 처리합니다.
...
## 출력 스키마
{"title":"숏폼 제목","duration":"20","hook":"첫 문장","scenes":[{"sceneNumber":1,"duration":"6","layout":"full","narration":"나레이션","visualDescription":"Visual description in English","textOverlay":"텍스트 오버레이","infographic":{"headline":"핵심 라벨","value":"+12.4%","subtitle":"부가 설명","chartType":"bar","theme":"beige"}}],"cta":"마무리 문구","thumbnailPrompt":"Thumbnail prompt in English","uploadTitle":"YouTube 제목","uploadDescription":"YouTube 설명","hashtags":["#Shorts","#태그"]}`
}
